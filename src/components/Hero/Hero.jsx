            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2">
                    <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
                        ...
                        initial="hidden"
                        animate="visible"
                        className="text-6xl font-bold"> Shop from any store anywhere with up to 30% discount </motion.h1>
                        <motion.p 
                        variants={FadeRight(0.9)} 
                        initial="hidden"
                        animate="visible"
                        className="text-sm sm:text-2xl lg:text-4xl">Shop the best product from any store with us. Our services are top-notch. </motion.p>
                        <motion.div
